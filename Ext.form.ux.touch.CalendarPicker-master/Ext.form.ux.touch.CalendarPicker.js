...
Ext.form.ux.touch.CalendarPickerField = Ext.extend(Ext.form.Field, {
    ...
    initCalendar: function() {
        ...
        this.calendar = new Ext.Panel({
            scroll: false,
            width: Ext.is.Phone ? Ext.Element.getViewportWidth() : 600,
            height: Ext.is.Phone ? Ext.Element.getViewportHeight() : 400,
    ...
    nextYear: function() {
        this.year += 1;
        console.log("called next year. "+this.year);
        this.drawCalendar();
    },

    prevYear: function() {
        this.year = this.year - 1;
        console.log("called previous year. "+this.year);
        this.drawCalendar();
    },
    ...
    drawCalendar: function() {
        ...
        //var dayselected = {13:'aspirin', 15:'foree'};
        var daysSelected = [];
        for (var i = 0; i < Foobar.data.length; i++) {
            if (Foobar.data[i].getMonth() == month && Foobar.data[i].getFullYear() == year) {
                daysSelected.push(Foobar.data[i].getDate());
            }
        }
        ...
        for (j = 0; j < 42; j++) {
            ...
            if ((j < firstDay)) {
                ...
                console.log("rowday is " +rowday+ ", ds: "+daysSelected);
                if (daysSelected.indexOf(rowday) != -1) {
                    clsSelected = ' calendar-select';
                }
